...
export default {
  ...
  this.total_amout_collect = this.total_amout_sum;
    ...
    trackJobActivity: function(){
      var startTrack = sessionStorage.getItem("startTrack");
      console.log("startTrack",startTrack);
      if(startTrack == 2){
        // axios
        // .get("/cost-estimate/detail-form/getTempData?timestamp=" + this.timestamp)
        // .then(function (response) {
        //   console.log("respon:");
      ...
      // if(latestSequence != ''){
      //   console.log("cookie latestSequence",latestSequence);
      // }
      
      // $(".detail-form-list").remove(); 
      // $(".detail-form-list").closest("tfoot").find("tr > td:first-child").html(latestSequence);
     
      // 
      
      // console.log(x+" = startTrack detail form ",startTrack);
      // // if(this.trackActivity == 1){
        
      //   if(startTrack == 2){
      //     var latestSequence = sessionStorage.getItem("latestSequence");
      //     latestSequence = latestSequence.split(":");

      //     var itemlist = $(".detail-form-list");
      //     var activity_code = latestSequence[0];
      //     var selected = $(".detail-form-list > tr[data="+activity_code+"]").index();
      //     // if(latestSequence[1] == 'up'){

      //     // }else{
            
      //     // }
      //     // console.log(latestSequence);
      //     // for(var i = 0; i < latestSequence.length;i++){

      //     // }
      //     // console.log(latestSequence);
      //     // sessionStorage.setItem("startTrack",3);
      //   }
      // }
    },
    activityWindow() {
