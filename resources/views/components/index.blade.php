    ...
    <table id="dt_table" class="table table-bordered">
        ...
        <tr>
            ...
            <td>
                ...
                <input type="hidden" disabled name="component_id[{{$component->id}}][component_id]" class="component_id form-control" value="{{ $component->component_id }}" />
            </td>            
            <td data-type="{{ $component->resource_type }}">
                <span class="compid_text">{{ $component->resource_type }}</span>
                <input type="hidden" disabled name="component_id[{{$component->id}}][resource_type]" class="component_id form-control" value="{{ $component->resource_type }}" />
            </td>
