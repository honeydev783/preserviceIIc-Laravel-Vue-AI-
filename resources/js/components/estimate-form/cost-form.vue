          ...
          <div class="form">          
                              ...
                              <div class="row">
                                  <div class="col-xs-6 col-sm-6 col-md-6">
                                      <div class="form-group">
                                          ...
                                          <select class="form-control" @change="getResults" id="category" v-model="category">
                                              <option value=""></option>
                                              <option v-for="temp in estimate" :key="temp.id" :value="temp.id">{{temp.menu_name}}</option>                                              
                                          </select>                                          
                                      </div>
                                  </div>
                                  <div class="col-xs-6 col-sm-6 col-md-6">
                                      <div class="form-group">
                                          ...
                                          <select class="form-control"" v-model="country" id="country" @change="getResults(($event))">
                                              <option value=""></option>
                                              <option v-for="con in countrys" :key="con.id" :value="con.id">{{con.country_name}}</option>                                              
                                          </select>                                          
                          ...
                          <div class="col-xs-6 col-sm-6 col-md-6">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-xs-6 col-sm-6 col-md-6">
                                        <div class="form-group">
                                          ...
                                          <select class="form-control" v-model="soil_conditions" @change="getResults(($event))">                                              
                              ...
                              <div class="form-group">
                                  <strong>PERCENTAGE ROCK IN SUBSTRUCTURE(%):</strong>
                                   <input type="number" min="0" max="100" class="form-control" v-model="rock_percent">             
                              </div>
                  ...
                  <div class="col-md-3">
                      <div class="row">
                          <div class="col-xs-12 col-sm-12 col-md-12">
                              <span @click="showModal('Image')" class="btn btn-success form-control" style="height: 55px; font-size: 14px;">DESIGN CONCEPT IMAGE ( Upload Drawing Plan Image )</span>
                          </div>
                      </div>
                      <div class="row">
                          <div class="col-xs-12 col-sm-12 col-md-12">
            ...
            <div class="row">        
                <div class="col-xs-12 col-sm-12 col-md-12">
                    ...
                    <span class="btn btn-success" data-toggle="modal" data-target="#modal-fullscreen-xl" @click="printForm" >Print / Preview</span>
                    <span class="btn btn-success" @click="showSaveModal">Save Estimate</span>                                                            

                    <div class="modal modal-fullscreen-xl printme" id="modal-fullscreen-xl" tabindex="-1" role="dialog" aria-hidden="true">
                            ...
                            <div class="modal-content">
                                ...
                                <div class="modal-body " id="print-this">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-10">
                                            <input style="border:1px solid #ccc" v-model="project_title_sum" type="text" class="form-control-plaintext" id="project_title_sum"  >
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label for="staticEmail" class="col-sm-2 col-form-label">
                                        ...
                                        <div class="col-sm-10">
                                            <input type="text"  style="border:1px solid #ccc" v-model="estimate_type_sum"  class="form-control-plaintext"  id="estimate_type_sum">
                                        </div>
                                    </div>                                    
                                    <div class="form-group row">
                                        <label for="staticEmail" class="col-sm-2 col-form-label">
                                        ...
                                        <div class="col-sm-10">
                                            <input type="text"   style="border:1px solid #ccc" v-model="project_location"  class="form-control-plaintext" id="project_location" >
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-10">
                                            <input type="text"   style="border:1px solid #ccc" v-model="cost_gross"  class="form-control-plaintext" id="cost_gross" >
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label for="staticEmail" class="col-sm-2 col-form-label">
                                        ...
                                        <div class="col-sm-10">
                                            <input type="text"   style="border:1px solid #ccc" v-model="e_cost_sf_sum"  class="form-control-plaintext" id="e_cost_sf_sum" >
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label for="staticEmail" class="col-sm-2 col-form-label">
                                        ...
                                        <div class="col-sm-10">
                                            <input type="text"   style="border:1px solid #ccc" v-model="e_cost_m2_sum"  class="form-control-plaintext" id="e_cost_m2_sum" >
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label for="staticEmail" class="col-sm-2 col-form-label">
                                        ...
                                        <div class="col-sm-10">
                                            <input type="text"   style="border:1px solid #ccc" v-model="num_unit"  class="form-control-plaintext" id="num_unit" >
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label for="staticEmail" class="col-sm-2 col-form-label">
                                        ...
                                        <div class="col-sm-10">
                                            <input type="text"   style="border:1px solid #ccc" v-model="num_story"  class="form-control-plaintext" id="num_story" >
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label for="staticEmail" class="col-sm-2 col-form-label">
                                        ...
                                        <div class="col-sm-10" style="display:flex;">
                                            <input type="text"   style="border:1px solid #ccc; width:50px;" v-model="rock_percent"  class="form-control-plaintext" id="rock_percent">                                            
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-10">
                                            <input type="text"   style="border:1px solid #ccc" v-model="project_cost_sum"  class="form-control-plaintext" id="project_cost_sum" >
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label for="staticEmail" class="col-sm-2 col-form-label">
                                        ...
                                        <div class="col-sm-10">
                                            <input type="text"   style="border:1px solid #ccc" v-model="description"  class="form-control-plaintext" id="description" >
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label for="staticEmail" class="col-sm-2 col-form-label">
                                        ...
                                        <div class="col-sm-10">
                                            <input type="text"   style="border:1px solid #ccc" v-model="conceptual_note"  class="form-control-plaintext" id="conceptual_note" >
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label for="staticEmail" class="col-sm-2 col-form-label">
                                        ...
                                        <div class="col-sm-10">
                                            <input type="text"   style="border:1px solid #ccc" v-model="estimate_note"  class="form-control-plaintext" id="estimate_note" >
                                        </div>
                                    </div>
                                     <div class="form-group row">
                                        <label for="staticEmail" class="col-sm-2 col-form-label">
                                        ...
                                        <div class="col-sm-10">
                                            <input type="text"   style="border:1px solid #ccc" v-model="exculstion_note"  class="form-control-plaintext" id="exculstion_note" >
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label for="staticEmail" class="col-sm-2 col-form-label">
                                        ...
                                        <div class="col-sm-10">
                                            <img :src="image_src" alt="Estimate Type Image" style="width:400px !important"></img>
                                        </div>
                                    </div>
                                    <table class="table table-striped table-bordered" id="print_1" style="background: aliceblue;" v-columns-resizable>
                                        <thead>
                                            <tr>
                                    ...
                                    <table class="table table-striped">
                                        <tr>
                                            <td Width="77%"><strong style="color:black">MAIN CONTRACTOR’S PRELIMINARIES (General Requirements)</strong></td>
                                            <td width="13%" align="right"><strong style="color:black">{{per_main_preliminary}} %</strong></td>
                                            <td width="10%" align="right"><strong style="color:black">{{main_preliminary_collect}}</strong></td>
                                        </tr>
                                        <tr>
                                            <td width="77%"><strong style="color:black">MAIN CONTRACTOR'S OVERHEADS & PROFIT</strong></td>
                                            <td width="13%" align="right"><strong style="color:black">{{per_main_profit}} %</strong></td>
                                            <td width="10%" align="right"><strong style="color:black">{{main_profit_collect}}</strong></td>
                                        </tr>
                                        <tr>
                                            <td width="77%"><strong style="color:black">TOTAL CONSTRUCTION COST - Contract Sum ( Excluding Contengencies and Contractor's Design Fees)</strong></td>
                                            <td width="13%" align="right"></td>
                                            <td width="10%" align="right"><strong style="color:black">{{contract_sum_collect}}</strong></td>
                                        </tr>
                                        <tr>
                                            <td width="77%"><strong style="color:black">PROJECT / DESIGN TEAM FEES</strong></td>
                                            <td width="13%" align="right"><strong style="color:black">{{per_team_fee}} %</strong></td>
                                            <td width="10%" align="right"><strong style="color:black">{{team_fee_collect}}</strong></td>
                                        </tr>
                                        <tr>
                                            <td width="77%"><strong style="color:black">OTHER DEVELOPMENT COST</strong></td>
                                            <td width="13%" align="right"><strong style="color:black">{{per_dev_cost}} %</strong></td>
                                            <td width="10%" align="right"><strong style="color:black">{{dev_cost_collect}}</strong></td>
                                        </tr>
                                        <tr>
                                            <td width="77%"><strong style="color:black">CONTENGENCIES (Client's Risk)</strong></td>
                                            <td width="13%" align="right"><strong style="color:black">{{per_client_risk}} %</strong></td>
                                            <td width="10%" align="right"><strong style="color:black">{{client_risk_collect}}</strong></td>
                                        </tr>
                                        <tr>
                                            <td width="77%"><strong style="color:black">TOTAL PROJECT COST</strong></td>
                                            <td width="13%" align="right"></td>
                                            <td width="10%" align="right"><strong style="color:black">{{project_cost|currency}}</strong></td>
                                        </tr>
                                    </table>                                                                                                           
                                </div>
                                <div class="modal-footer">
                                    <button type="button" class="btn btn-secondary" data-dismiss="modal" @click="printCloseFirst()">Close</button>
            ...
            <div class="row">        
                <div class="col-xs-12 col-sm-12 col-md-12">
                    <p>
                        NOTE: ADD YOUR BUILDING SQUARE FOOTAGE; PERCENTAGE ROCK (ROCK SHALL MEAN ANY MEDUIM TO HARD EARTH EXCAVATION) IN SUBSTRUCTURE EXCAVATION; PRESS RUN AND / OR PRINT TO OBTAIN YOUR CONSTRUCTION COST
                    </p>
                    <p>
                        ADD: PERCENTAGE FOR PRELIMINARIES; OVERHEADS &PROFIT; DESIGN FEES; OTHER COST AND CONTINGENIES, THEN CALCULATE TO OBTAIN PROJECT COST
                    </p>
                  ...
                  <table class="table table-bordered text-white">                    
                      <tbody>
                          <tr>
                              ...
                              <td width="15%">
                                    <input type="text" class="form-control" v-model="main_preliminary_collect" v-on:keyup="preliminaryKeyUp" v-on:mouseleave="permainpreliminary"> 
                          ...
                          <tr>
                              ...
                              <td><strong>%</strong></td>
                              <td>
                                    <input type="text" class="form-control" v-model="main_profit_collect" v-on:keyup="mainProfitKeyUp" v-on:mouseleave="mainProfit">
                          ...
                          <tr>
                              ...
                              <td>
                                    <input type="text" class="form-control" v-model="contract_sum_collect" v-on:keyup="contractSumKeyUp" v-on:mouseleave="contractsum">
                                    <!-- <span class="form-control">{{contract_sum|currency}}</span> -->
                              </td>
                          </tr>
                          <tr>
                              ...
                              <td><strong>%</strong></td>
                              <td>
                                    <input type="text" class="form-control" v-model="team_fee_collect" v-on:keyup="teamFeeKeyUp" v-on:mouseleave="teamFee">
                          ...
                          <tr>
                              ...
                              <td><strong>%</strong></td>
                              <td>
                                    <input type="text" class="form-control" v-model="dev_cost_collect" v-on:keyup="devCostKeyUp" v-on:mouseleave="devCost">
                          ...
                          <tr>
                              ...
                              <td><strong>%</strong></td>
                              <td>
                                    <input type="text" class="form-control" v-model="client_risk_collect" v-on:keyup="clientRiskKeyUp" v-on:mouseleave="clientRisk">
                          ...
                          <tr>
                              ...
                              <td>
                                    <input type="text" class="form-control" v-model="project_cost_collect" v-on:mouseleave="projectCost">
                                   <!-- <span class="form-control">{{project_cost|currency}}</span>  -->                             
                              </td>
                          </tr>
                          <tr>
