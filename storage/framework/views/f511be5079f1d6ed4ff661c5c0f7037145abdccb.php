                            ...
                            <table class="table table-bordered" id="dynamicTable_<?php echo e($country->country); ?>">
                                ...
                                <tbody class="row_position">
                                    <tr id="row_<?php echo e($country->country); ?>_<?php echo e($k); ?>">
                                        <td>
                                            <div class="form-group">
                                                <input type="text" id="input_rate_<?php echo e($country->country); ?>" name="rate[<?php echo e($country->country); ?>]" class="form-control" oninput="rateCal(<?php echo e($country->country); ?>, this)" value="<?php echo e($country->orignal_rate); ?>">
                                            </div>
                                        </td>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home3/lobalpx1/public_html/admin/resources/views/components/edit.blade.php ENDPATH**/ ?>