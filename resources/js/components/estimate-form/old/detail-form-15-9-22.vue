                      ...
                      >
                        ...
                        <tbody v-if="loadResourceComponent">
                          ...
                          >
                            ...
                            <td>{{ rescomponent.rate | currency }}</td>
                            ...
                            <td>{{ rescomponent.ohp | currency }}</td>
                            <td>{{ rescomponent.cont | currency }}</td>
                            <td>{{ rescomponent.res_amount | currency }}</td>
                          </tr>
