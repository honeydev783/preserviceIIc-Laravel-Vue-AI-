  ...
  methods: {
    ...
    getVertexResults: function () {
      ...
      axios.get("/predict?text=" + project_specification).then(function (response) {
        ...
        project_specification_textarea.value = _this.project_specification;
      });
      ...
      axios.get("/predict?text=" + component_note).then(function (response) {
        ...
        component_note_textarea.value = _this.component_note;
      });
      _this.$Progress.finish();
      _this.loading = false;
    ...
    getActivity: function () {
      ...
      _this.$Progress.start();
      _this.loading = true;
      console.log("activity_description================>", _this.activity_description);
      axios
    ...
    getComponents() {
      ...
      axios
        ...
        .then(function (response) {
          ...
          console.log("getComponents================>", response.data.data);
        ...
        .then((response) => {
          ...
          response.data.data.components.forEach((value, index) => {
            if (value.category == "Labour") {
              ...
              console.log("labourTotal in=========>", labourTotal);
          ...
          console.log("labourTotal out=========>", labourTotal);
