...
<div class="row">
        <div class="col-lg-12 margin-tb">
            ...
            <div class="pull-right mb-2">             
                ...
                <a class="btn btn-info" href="<?php echo e(route('resource_components.global')); ?>"> Set Global</a>               
            </div>
        </div>
    </div>
    ...
    <table id="dt_table" class="table table-bordered">
        ...
        <tr>
            ...
            <td>
                ...
                <input type="hidden" disabled name="component_id[<?php echo e($component->id); ?>]" class="component_id form-control" value="<?php echo e($component->component_id); ?>" />
            </td>            
            <td data-type="<?php echo e($component->resource_type); ?>"><?php echo e($component->resource_type); ?></td>
        ...
        <?php if(!empty($country_components)): ?>
            <?php $__currentLoopData = $country_components; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $component): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>            
                <tr>
                    <th></th>
                    <td></td>            
                    <td></td>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/gdomqnh9pbj7/public_html/admin.globalpreservicesllc.com/resources/views/components/master_index.blade.php ENDPATH**/ ?>