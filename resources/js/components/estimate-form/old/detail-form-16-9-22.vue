          ...
          <div class="row">
              ...
              <div class="row">
                ...
                <div class="col-xs-5 col-sm-5 col-md-5">
                  ...
                  <div class="row">
                    ...
                    <div class="col-sm-8">
                      <div class="form-group">
                        <strong>PRELIMINARY COST:</strong>
            ...
            <div class="col-md-4" style="padding-top: 20px">
              ...
              <div class="row">
                ...
                <div class="col-xs-12 col-sm-12 col-md-12">
                  <div class="form-group">
                    <strong>Component List Notes:</strong>
                    <textarea
                      class="form-control"
                      rows="5"
                      ...
                      >
                        ...
                        <tbody v-if="loadResourceComponent">
                          ...
                          <tr>
                            ...
                            <td>{{ this.total_amout_sum | currency }}</td>
                          </tr>
                          <tr>
                            <td colspan="10"></td>
                            <td colspan="2">TOTAL-LABOUR-COST</td>
                            <td>{{ this.total_labour_sum | currency }}</td>
                          </tr>
                          <tr>
                            <td colspan="10"></td>
                            <td colspan="2">TOTAL-EQUIPMENT-COST</td>
                            <td>{{ this.total_equipment_sum | currency }}</td>
                          </tr>
                          <tr>
                            <td colspan="10"></td>
                            <td colspan="2">TOTAL-MATERIAL-COST</td>
                            <td>{{ this.total_material_sum | currency }}</td>
                          </tr>
                          <tr>
                            <td colspan="10"></td>

                            <td colspan="2">ADDITIONAL COST</td>
                            <td>{{ this.total_addition_sum | currency }}</td>
                          </tr>
                          <tr>
                            <td colspan="10"></td>
                          ...
                          <tr>
                            ...
                            <td>{{ this.total_ohp_sum | currency }}</td>
                          </tr>
                          <tr>
                            <td colspan="10"></td>
                          ...
                          <tr>
                            ...
                            <td>{{ this.total_amout_collect | currency }}</td>
                          </tr>
                        </tbody>
                      </table>
                    </div>
                      ...
                      >
                        ...
                        <tbody v-if="loadResourceComponent">
                          ...
                          >
                              ...
                              >
                                ...
                                <tbody>
                                  ...
                                  <tr>
                                    ...
                                    <td></td>
                                    <td></td>
                                    <td>{{ rescomponent.res_sum | currency }}</td>
                                  </tr>
                                </tbody>
                              </table>
                            </td>
                            <td>{{ rescomponent.unit }}</td>
                            <td>{{ (rescomp_total/rescomponent.quantity).toFixed(2) }}</td>
                            ...
                            <td v-if="lab_category">{{ rescomponent.lab + ((rescomponent.lab * overhead_percentage)/100) + ((rescomponent.lab * consistgency_percentage)/100) + ((rescomponent.lab * preliminary_percentage)/100) | currency }}</td>
                            <td v-if="eqp_category">{{ rescomponent.eqp + ((rescomponent.eqp * overhead_percentage)/100) + ((rescomponent.eqp * consistgency_percentage)/100) + ((rescomponent.eqp * preliminary_percentage)/100) | currency }}</td>
                            <td v-if="mat_category">{{ rescomponent.mat + ((rescomponent.mat * overhead_percentage)/100) + ((rescomponent.mat * consistgency_percentage)/100) + ((rescomponent.mat * preliminary_percentage)/100) | currency }}</td>
                          ...
                          <tr>
                            <td colspan="7"></td>
                            <td colspan="3">SUB-TOTAL-COST</td>
                            <td>{{ this.rescomp_sub_total | currency }}</td>
                          </tr>
                          <tr v-if="lab_category"> 
                            <td colspan="7"></td>
                            <td colspan="3">TOTAL-LABOUR-COST</td>
                            <td>{{ this.lab_category_sum | currency }}</td>
                          </tr>
                          <tr v-if="eqp_category">
                            <td colspan="7"></td>
                            <td colspan="3">TOTAL-EQUIPMENT-COST</td>
                            <td>{{ this.eqp_category_sum | currency }}</td>
                          </tr>
                          <tr v-if="mat_category">
                            <td colspan="7"></td>
                            <td colspan="3">TOTAL-MATERIAL-COST</td>
                            <td>{{ this.mat_category_sum | currency }}</td>
                          </tr>
                          <tr>
                            <td colspan="7"></td>
                          ...
                          <tr>
                            <td colspan="7"></td>
                            <td colspan="3">TOTAL COST</td>
                            <td>{{ this.rescomp_total | currency }}</td>
                          </tr>
                        </tbody>
                      </table>
                    </div>
                  ...
                  >
                    ...
                    <td>
                      ...
                      <input
                        ...
                        style="display: none"
                        :value="component.element_description"
                      />
                    </td>
                    <td>
                    ...
                    <td>
                      ...
                      <span
                        class="btn btn-success"
                        :id="'up-btn-' + i"
                        @click="up(component.activity_code)"
                        >Up</span
                      >
                      <span
                        class="btn btn-success"
                        :id="'down-btn-' + i"
                        @click="down(component.activity_code)"
                        >Down</span
                      >
                      <span
                        class="btn btn-success"
...
export default {
  ...
  methods: {
    ...
    getComponents() {
      ...
      axios
        ...
        .then(function (response) {
          ...
          _this.country_job = $("#country").find(":selected").text();
          _this.$Progress.finish();
          _this.loading = false;
        });
    },
    ...
    loadComponent() {
      ...
      var lists = {
        ...
        rate: this.imperial_rate_collect,
  ...
  this.total_amout_collect = this.total_amout_sum;
        ...
        .then((response) => {
          ...
          _this.components = response.data.data.components.map((item, key) => {
            return {
              ...
              quantity: parseFloat(
                parseFloat(item.quantity).toFixed(6) * this.quantity
              ).toFixed(6),
              unit: item.unit,
              rate: item.rate,
    ...
    printForm() {
      this.country_name = $("#country").find(":selected").text();
    ...
    doneUpdate(index) {
      ...
      $("#edit-btn-" + index).css("display", "inline-flex");
      $("#delete-btn-" + index).css("display", "inline-flex");
      $("#up-btn-" + index).css("display", "inline-flex");
      $("#down-btn-" + index).css("display", "inline-flex");
      $("#activity_code_" + index).css("display", "none");
      $("#element_description_" + index).css("display", "none");
      $("#job_activity_" + index).css("display", "none");
      $("#activity_code_label" + index).css("display", "inline-flex");
      $("#element_description_label" + index).css("display", "inline-flex");
      $("#job_activity_label" + index).css("display", "inline-flex");
    ...
    saveForm() {
      ...
      axios
        .post("/cost-estimate/detail-form/saveForm", {
          ...
          totalCalculation: _this.totalCalculation,
    ...
    activityWindow() {
      sessionStorage.setItem(
        "totalCalculation",
        JSON.stringify(this.totalCalculation)
      );
      // this.open = true;
      // alert(this.open);
      this.activity = window.open(
        "http://admin.globalprecisionalservicesllc.com/cost-estimate/detail-form/activity",
        "Activity",
