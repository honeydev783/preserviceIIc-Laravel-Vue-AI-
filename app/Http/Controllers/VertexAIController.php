...
class VertexAIController extends Controller
{
    ...
    //     $ch = curl_init();
    //     curl_setopt($ch, CURLOPT_URL, "https://us-central1-aiplatform.googleapis.com/v1/projects/474073143471/locations/us-central1/publishers/google/models/text-bison:predict");
    //     curl_setopt($ch, CURLOPT_POST, true); // Change to false if GET
    //     curl_setopt($ch, CURLOPT_RETURNTRANSFER, true);
    //     $prompt = $request->text;
    ...
    //     return $aidata;
    // }
    public function predictimages1(Request $request)
    {
        $keyFilePath = env('GOOGLE_APPLICATION_CREDENTIALS');
        $client = new Client();
