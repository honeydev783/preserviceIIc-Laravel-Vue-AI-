...
<form action="<?php echo e(route('job_activities.copydata')); ?>" method="POST">
    <?php echo csrf_field(); ?>  
    <div class="row">  
                        ...
                        <?php if(!empty($job_component_data)): ?>
                            <?php $__currentLoopData = $job_component_data; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                ...
                                <table class="table table-bordered" id="dynamicTable_<?php echo e($value['country']['id']); ?>">  
                                    <tr>
                                        <th colspan="3"><?php echo e($value['country']['country_name']); ?></th>
                                    </tr>
                                    <tr>
                                        <th>COMPONENTS</th>
                                        <th>QUANTITY</th>                                    
...
$('#mySelect2').on('select2:select', function (e) {
    ...
    $.ajax({
        ...
        success : function(result){         
            ...
            // html +=                         '<option value="<?php echo e($component->id); ?>">'+<?php echo e($component->component_id); ?>+'</option>';
            //                             <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>   
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/gdomqnh9pbj7/public_html/admin.globalpreservicesllc.com/resources/views/job_activities/copy.blade.php ENDPATH**/ ?>