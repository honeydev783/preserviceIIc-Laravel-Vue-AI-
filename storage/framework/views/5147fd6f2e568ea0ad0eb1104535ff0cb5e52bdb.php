<div class="bg-light border-right" id="sidebar-wrapper">
    ...
    <div class="list-group list-group-flush">       
        ...
        <ul class="list-unstyled">
            ...
            <?php if(Auth::user()->role == 1): ?>
                ...
                <li class="<?php echo e(strpos(Route::currentRouteName(),'countries') !== false ? 'active' : ''); ?>">
                    <a href="<?php echo e(route('countries.index')); ?>" class="">
                        <i class="fas fa-address-card"></i> Countries</a>
                </li>
 ...
 <?php /**PATH /home/gdomqnh9pbj7/public_html/admin1/resources/views/layouts/sidebar.blade.php ENDPATH**/ ?>