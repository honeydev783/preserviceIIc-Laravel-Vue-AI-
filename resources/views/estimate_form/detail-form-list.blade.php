...
@section('contentheader_title','Detail Estimate Cost Form List')
@section('styles')
<style>
    .pull-right{
        float: right;
...
@section('content')
    ...
    <table class="table table-bordered">
        ...
        <tr>
            ...
            <td>                
                <a class="btn btn-primary" href="{{route('detail-estimate.restore_form',$costForm->id)}}">Restore</a>
                <a class="btn btn-danger" href="{{route('detail-estimate.destroy',$costForm->id)}}">Delete</a>
            </td>
            <td>
