        ...
        <div class="col-lg-12 margin-tb mb-3">
            ...
            <div class="pull-right mb-2"> 
                ...
                ?>
                        ...
                        <a class="btn btn-info" href="<?php echo e(route('job_activities.global')); ?>"> Set Global</a>               
                    </div>
            ...
            <tbody class="row_position">
                ...
                <tr id="<?php echo e($active->id); ?>">
                    ...
                    <td>
                        ...
                        <?php echo e($res->component->component_id ?? Null); ?> / <?php echo e($res->quantity); ?> </br>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </td> 
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/gdomqnh9pbj7/public_html/admin.globalpreservicesllc.com/resources/views/job_activities/index.blade.php ENDPATH**/ ?>